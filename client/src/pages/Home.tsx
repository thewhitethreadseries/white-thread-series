  ...
  return <main className="site-shell">
    ...
    <section id="top" className="hero-section">
      ...
      <div className="container hero-grid">
        <div className="hero-copy reveal reveal-one"><p className="eyebrow">Urban fantasy · dark psychology · supernatural mystery</p><h2>The White<br /><i>Thread</i> Series</h2><p className="hero-line">Launching<br /><strong>November 13th 2026</strong><small>6.30AM IST · 1 AM GST</small></p></div>
