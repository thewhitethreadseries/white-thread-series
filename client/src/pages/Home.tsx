  ...
  return <main className="site-shell">
    ...
    <section id="the-book" className="book-section section-pad"><div className="container">
      ...
      <div className="book-intro-grid">
        ...
        <div className="book-copy reveal reveal-two"><p className="eyebrow mint">Till the Day We Can</p><h2>Till the day<br /><i>we can.</i></h2><Countdown /><div className="release-line"><span>Launching</span><strong>November 13th 2026</strong></div><p className="seo-sentence">An Urban Fantasy where a former bodyguard learns that the entity responsible for his sister’s death is still out there, spreading a deadly spirit illness, and ends up becoming the reluctant protector of a self-proclaimed last healer, the only person who can help to hunt it.</p><div className="book-actions"><ActionLink href={LINKS.arc} filled>Join the ARC reader list</ActionLink><ActionLink href={LINKS.amazonEbook}>Purchase ebook · Amazon</ActionLink><ActionLink href={LINKS.amazonPaperback}>Purchase paperback · Amazon</ActionLink><ActionLink href={LINKS.signedPaperback}>Pre-order paperback with signature</ActionLink></div><p className="placeholder-hint">Purchase links will be attached here when live.</p></div>
      </div>
    </div></section>

    <section className="blurb-section section-pad"><div className="container blurb-grid"><div className="blurb-aside"><span className="vertical-label">Mekhsul</span></div><div className="blurb-copy"><p className="eyebrow violet">Mekhsul - A City with another side</p><p className="blurb-opening">Those who could see the Spirit Dimension could see the Threads between people.<br /><br />Those who carried Eshkai blood could wield the abilities of the keepers of balance.</p><h2>Some illnesses<br /><i>are not of the body.</i></h2><div className="blurb-text"><p>Xal Renharth was neither until he met Kian Vaeloren, who felt like a fraction of nostalgia and a bane in full.</p><p>Kian was the last healer, a magnet for angry ghosts and grieving families, a perfect enigma who ensured what was dead stayed dead. Xal, meanwhile, was a mundane bodyguard with no patience, a stranger to the supernatural and its rules, an unyielding sentinel who prioritized his family’s safety at any cost.</p><p>When a rare incident occurred, Xal agreed to partner up with Kian to help spirits and the living, only under the condition to hunt down the entity that had been spreading a deadly spirit-illness through Mekhsul City for over a decade, undetected by even the latest technologies. Xal insisted on killing it to stop the rising deaths, as revenge plagued his mind, while Kian refused to allow another death to fall under his name, guilt threatening his sanity.</p><p>Can they stop the entity before more lives are lost, or will they break under the weight of unraveling secrets darker than death itself?</p></div></div></div></section>
