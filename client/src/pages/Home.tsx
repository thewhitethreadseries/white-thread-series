...
export default function Home() {
  return <main className="site-shell">
    ...
    <section className="meta-section"><div className="container meta-layout"><div><p className="eyebrow mint">The White Thread Series</p><h3>Urban fantasy<br /><i>with Dark Psychology and Supernatural Mystery.</i></h3></div><div className="tag-list"><span>Urban Fantasy</span><span>Dark Psychology</span><span>Supernatural Mystery</span><span>Spirit Dimension Thriller</span><span>Soul Friend Bond</span><span>Extinct Clan Lore</span><span>Bromance Book</span></div></div></section>
